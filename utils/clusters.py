...
def cluster_attributes() -> List[str]:
    return ['cluster_id', 'creator_user_name', 'driver_healthy', 'cluster_name',
            'spark_version', 'azure_attributes', 'node_type_id', 'driver_node_type_id',
            'spark_env_vars', 'autotermination_minutes', 'enable_elastic_disk',
            'disk_spec', 'cluster_source', 'single_user_name',
            'enable_local_disk_encryption', 'instance_source', 'driver_instance_source',
            'data_security_mode', 'runtime_engine', 'effective_spark_version',
            'state', 'state_message', 'start_time', 'terminated_time',
            'last_state_loss_time', 'last_activity_time', 'last_restarted_time',
            'autoscale', 'default_tags', 'termination_reason', 'init_scripts_safe_mode']